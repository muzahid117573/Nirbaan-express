...
class EditProfileViewModel extends MyBaseViewModel {
  ...
  TextEditingController actypeTEC = new TextEditingController();
  TextEditingController acnumTEC = new TextEditingController();
  ...
  processUpdate() async {
    ...
    if (formKey.currentState.validate()) {
      ...
      final apiResponse = await _authRequest.updateProfile(
          ...
          actype: actypeTEC.text,
          acnumber: acnumTEC.text);
