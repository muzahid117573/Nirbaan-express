  ...
  placeOrder() async {
    ...
    if (isScheduled && checkout.deliverySlotDate.isEmptyOrNull) {
      ...
      CoolAlert.show(
        ...
        title: "Delivery Date",
        text: "Please select your desire order date",
      );
      ...
      CoolAlert.show(
        ...
        type: CoolAlertType.error,
        title: "Delivery Time",
        text: "Please select your desire order time",
      );
      ...
      CoolAlert.show(
        ...
        type: CoolAlertType.error,
        title: "Delivery address",
        text: "Delivery address is out of vendor delivery range",
      );
    ...
    } else if (!verifyVendorOrderAmountCheck()) {
      print("Failed");
    }
