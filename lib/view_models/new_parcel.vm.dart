...
class NewParcelViewModel extends PaymentViewModel {
  ...
  void initialise() async {
    ...
    currentLocationChangeStream =
      ...
      (location) async {
        ...
        packageLengthTEC = currentUser.actype;
        packageHeightTEC = currentUser.acnumber;
  ...
  validateDeliveryParcelInfo() {
    if (packageInfoFormKey.currentState.validate()) {
      ...
      packageCheckout.height = packageHeightTEC;
      packageCheckout.length = packageLengthTEC;
