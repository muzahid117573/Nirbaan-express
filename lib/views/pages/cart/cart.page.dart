                ...
                if (model.cartItems.isEmpty)
                  ...
                  VStack(
                    [
                      ...
                      ApplyCoupon(model),
                      UiSpacer.verticalSpace(),
                      AmountTile("Total Item", model.totalCartItems.toString()),
                      AmountTile("Sub-Total",
                          "${model.currencySymbol} ${model.subTotalPrice.numCurrency}"),
                      AmountTile("Discount",
                          "${model.currencySymbol} ${model.discountCartPrice.numCurrency}"),
                      DottedLine(dashColor: context.textTheme.bodyText1.color)
                          .py12(),
                      AmountTile("Total",
                          "${model.currencySymbol} ${model.totalCartPrice.numCurrency}"),
                      //
                      CustomButton(
                        title: "CHECKOUT",
